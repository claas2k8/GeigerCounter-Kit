...
void loop() {
  ...
  float voltage = 0.0;
  float scaleValue = 0.0;   // what we will show as "Scale" in the plotter
  ...
  if (!digitalRead(CHECK_PIN)) {
    ...
    scaleValue = 0.0; // CHECK mode indicator
  }
  ...
  // ---- Serial Plotter output: CPM, Voltage, Scale ----
  Serial.print("CPM:");
  Serial.print(cpmFiltered, 1);

  Serial.print(" Voltage:");
  Serial.print(voltage, 3);

  Serial.print(" Scale:");
  Serial.println(scaleValue, 0);
